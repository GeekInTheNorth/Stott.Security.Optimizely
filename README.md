...
- **Extensible Configuration:** Sources can be defined at a Global, Site, Host and even page level.  Allowing you to layer your CSP according to your requirements
...
- **Searchable:** Search by domain or filter by permission to fully understand what permissions have been granted.
- **Overridable:** Declare a common Global set of permissions, or vary them entirely by Site or Host.
...
- **Overridable:** Declare a common Global set of response headers, or vary them entirely by Site or Host.
...
- **Multi-Site / Host Support:** Write a single security.txt file for your entire CMS, or create them by site or even specific host. 
...
Many of these features use a Context Switcher which allows you to view or vary your configuration at a Global, Site or Host level.

![Stott Security Context Switcher](/Images/ContextSwitcher.png)

- An entry for "All Sites" will exist as a Global Configuration.
- An entry will exist for each Site you have configured within your CMS.
- If an Site has more than one visitable Host, then entries will be shown for each available Host Name.

> **TIP:** If you want to specify a different set of security headers for the frontend and the CMS backend of your site, then make sure you configure separate Primary and Edit host names.

### Content Security Policy

The Content Security Policy is split four tabs and has a single Context Selector defined.  The idea of these settings it allows you to define a configuration at either a Global, Site or Host level.

#### Content Security Policy - General Settings

> **Context Switcher:** Allows you to configure global settings, or to override them at an Site or Host level.
...
> **Context Switcher:** Allows you to configure global settings, or to **extend** them at an Site and/or Host level.  Sources from matching Global, Site and Host levels will be merged and optimized to prevent duplication.
...
- Only grant **default-src** to either the **'self'** or **'none'** directive.
  ...
  - Granting **'none'** the **default-src** directive will say that neither the current site or any third party can perform any action by default.  This will require you to grant specific directives to **'self'**
    - Using **'none'** for a directive will result in any other source at any level (Global, Site, Host or Page) being disregarded for that directive.
...
> **Context Switcher:** Shows you violations that relate to your selected Site and Host.  When you use the "Create CSP Entry" CTA here, it will respect your currently chosen context.
...
> **Context Switcher:** Allows you to configure global settings, or to override them at an Site or Host level. When you choose to override at an site or host level, settings from the nearest lower level will be replicated.
...
> **Context Switcher:** Allows you preview what your headers will be at a Global, Site or Host level.
...
The tools tab introduces the ability to import and export your entire configuration.  The Export function will allow you to select a single Global, Site or Host Name context to export as a JSON file.  The Import function will require the same JSON file structure and will allow you to choose any Global, Site or Host Name level to import the settings back in.

There was a lot of consideration around whether export and import should include all contexts.  A decision was made to export and import at a specific level.  This allows you to copy settings from one Site to another irrespective of whether it is in the same environment or not.
...
If your solution is headless with multiple sites or hosts, you can also specify the `siteId` or `hostName` you want to retrieve your headers for.
...
- /stott.security.optimizely/api/compiled-headers/list/?siteId=00000000-0000-0000-0000-000000000000&hostName=example.com
- /stott.security.optimizely/api/compiled-headers/list/?siteId=00000000-0000-0000-0000-000000000000&hostName=example.com&pageId=123
...
- /stott.security.optimizely/api/compiled-headers/{headerName}?siteId=00000000-0000-0000-0000-000000000000&hostName=example.com
- /stott.security.optimizely/api/compiled-headers/{headerName}?siteId=00000000-0000-0000-0000-000000000000&hostName=example.com&pageId=123
