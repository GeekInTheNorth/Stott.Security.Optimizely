...
function PermissionsPolicyCard(props)
{
    ...
    return (
        <Card className='my-2'>
            ...
            {!props.isInherited && (
                <Card.Footer>
                    <EditPermissionPolicy directive={props.directive} showToastNotificationEvent={handleShowToastNotification} siteId={siteId} hostName={hostName} />
                </Card.Footer>
            )}
        </Card>
    )
...
PermissionsPolicyCard.propTypes = {
