...
function EditPermission({ sourceData, reloadSourceEvent, showToastNotificationEvent }) {
    ...
    return (
        <>
            ...
            {showEditModal && <PermissionModal show={showEditModal} id={cspOriginalId} source={cspOriginalSource} directives={cspOriginalDirectives} closeModalEvent={handleCloseEditModal} updateSourceState={setCspOriginalSource} updateDirectivesState={handleUpdateDirectives} showToastNotificationEvent={showToastNotificationEvent} siteId={sourceData.siteId} hostName={sourceData.hostName} />}
            <ConfirmationModal
