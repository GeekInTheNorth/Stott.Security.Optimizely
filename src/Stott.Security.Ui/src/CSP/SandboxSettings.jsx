...
const SandboxSettings = (props) =>
{
    ...
    const handleRevertToInherited = async () => {
        try {
            await axios.delete(import.meta.env.VITE_SANDBOX_DELETE_URL, { params: { appId: props.appId, hostName: props.hostName } });
    ...
    const getCspSandboxSettings = async () => {
        await axios.get(import.meta.env.VITE_SANDBOX_GET_URL, { params: { appId: props.appId, hostName: props.hostName } })
            .then((response) => {
        ...
        <Container fluid='md'>
            ...
            {isContextSpecific && !isInherited && (
                <div className="alert alert-warning d-flex align-items-center justify-content-between">
                    ...
                    <Button variant="outline-warning" size="sm" onClick={handleRevertToInherited}>Revert to inherited</Button>
                </div>
            )}
