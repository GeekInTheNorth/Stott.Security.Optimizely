...
function CspSourceModal(props){
    ...
    const handleCommitSave = (event) => {
        ...
        axios.post(import.meta.env.VITE_APP_CSP_SOURCES_SAVE, params)
            .then(() => {
    ...
    const getValidDirectives = useCallback(
        debounce(async (sourceName) => {
            axios.get(import.meta.env.VITE_APP_CSP_SOURCES_VALIDDIRECTIVES, { params: { source: sourceName } })
                .then((response) => {
