...
public sealed class SecurityAdminMenuProvider : IMenuProvider
{
    public IEnumerable<MenuItem> GetMenuItems()
    {
        ...
        yield return CreateMenuItem("Custom Headers", "/global/cms/stott.security.optimizely/all.custom.headers", "/stott.security.optimizely/administration/#custom-headers", SortIndex.Last + 9);
        yield return CreateMenuItem("Header Preview", "/global/cms/stott.security.optimizely/header.preview", "/stott.security.optimizely/administration/#header-preview", SortIndex.Last + 10);
        yield return CreateMenuItem("Security.txt Files", "/global/cms/stott.security.optimizely/security.txt", "/stott.security.optimizely/administration/#security-txt", SortIndex.Last + 11);
        yield return CreateMenuItem("Audit", "/global/cms/stott.security.optimizely/audit", "/stott.security.optimizely/administration/#audit-history", SortIndex.Last + 12);
        yield return CreateMenuItem("Tools", "/global/cms/stott.security.optimizely/tools", "/stott.security.optimizely/administration/#tools", SortIndex.Last + 13);
    }
