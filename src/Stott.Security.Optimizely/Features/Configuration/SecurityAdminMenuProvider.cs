...
public sealed class SecurityAdminMenuProvider : IMenuProvider
{
    public IEnumerable<MenuItem> GetMenuItems()
    {
        ...
        yield return CreateMenuItem("Response Headers", "/global/cms/stott.security.optimizely/all.security.headers", "/stott.security.optimizely/administration/#all-security-headers", SortIndex.Last + 7);
        yield return CreateMenuItem("Header Preview", "/global/cms/stott.security.optimizely/header.preview", "/stott.security.optimizely/administration/#header-preview", SortIndex.Last + 8);
        yield return CreateMenuItem("Audit", "/global/cms/stott.security.optimizely/audit", "/stott.security.optimizely/administration/#audit-history", SortIndex.Last + 9);
        yield return CreateMenuItem("Tools", "/global/cms/stott.security.optimizely/tools", "/stott.security.optimizely/administration/#tools", SortIndex.Last + 10);
    }
