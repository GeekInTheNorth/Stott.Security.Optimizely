...
namespace Stott.Security.Optimizely.Migrations
{
    ...
    [Migration("20260323222030_AddMultiSiteCustomHeaders")]
    partial class AddMultiSiteCustomHeaders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Stott.Security.Optimizely.Entities.CspViolationSummary", b =>
                {
                    ...
                    b.HasIndex(new[] { "BlockedUri", "ViolatedDirective", "AppId", "HostName" }, "idx_CspViolationSummary_LookUp");
            ...
            modelBuilder.Entity("Stott.Security.Optimizely.Entities.CustomHeader", b =>
                {
                    ...
                    b.HasIndex(new[] { "HeaderName", "AppId", "HostName" }, "idx_CustomHeader_LookUp");
