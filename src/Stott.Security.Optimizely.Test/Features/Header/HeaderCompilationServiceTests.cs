...
public sealed class HeaderCompilationServiceTests
{
    ...
    public async Task GetSecurityHeadersAsync_UsesDefaultCacheKeyWhenThereIsNoPageData()
    {
        ...
        // Assert
        Assert.That(cacheKeyUsed, Is.EqualTo(CspConstants.CacheKeys.CompiledHeaders + "_global_all"));
    }
    ...
    public async Task GetSecurityHeadersAsync_UsesDefaultNoNonceOrHashCacheKeyWhenPageDataIsACspPageWithAnEmptySourceCollectionOnAUnsupportedRoute()
    {
        ...
        // Assert
        Assert.That(cacheKeyUsed, Is.EqualTo(CspConstants.CacheKeys.CompiledHeadersNoHash + "_global_all"));
    }
