...
public sealed class CspServiceTests
{
    ...
    public async Task GetCompiledHeaders_GivenNullCspSourcesAndNullPageSources_NoHeadersAreReturned()
    {
        ...
        _mockPermissionService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync((IList<CspSource>)null);
    ...
    public async Task GetCompiledHeaders_GivenEmptyCspSourcesAndNullPageSources_NoHeadersAreReturned()
    {
        // Arrange
        SetupCspSettings(true);
        _mockPermissionService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync([]);
        ...
        string expectedPolicy)
    {
        // Arrange
        SetupCspSettings(true);
        _mockPermissionService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(sources);
    ...
    public async Task GetCompiledHeaders_GivenCspSettingsAreAbsentThenTheSandboxIsNotIncluded()
    {
        ...
        _mockPermissionService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(sources);
        _mockSandboxService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(sandbox);
    ...
    {
        // Arrange
        _mockSettingsService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync((CspSettings)null);
    ...
    private void SetupCspSettings(bool isEnabled, bool isReportOnly = false, bool useInternalReporting = false, bool useExternalReporting = false, bool isUpgradeInsecureRequestsEnabled = false)
    {
        ...
        _mockSettingsService.Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(settings);
    }
}