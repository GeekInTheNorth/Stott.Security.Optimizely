...
public sealed class CspServiceTests
{
    ...
    public async Task Build_GivenAVarietyOfAllSourceTypes_ThenSourcesShouldBeCorrectlyOrdered()
    {
        ...
        var expectedHeader = "default-src 'self' 'nonce-random' 'strict-dynamic' 'unsafe-eval' 'wasm-unsafe-eval' 'unsafe-inline' 'unsafe-hashes' 'inline-speculation-rules' blob: data: filesystem: http: https: ws: wss: mediastream: https://www.example.com;";
