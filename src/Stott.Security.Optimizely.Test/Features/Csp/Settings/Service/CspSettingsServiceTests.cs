...
public sealed class CspSettingsServiceTests
{
    ...
    public async Task SaveAsync_PerformsNoActionsWhenModelIsNull()
    {
        ...
        // Assert
        _mockRepository.Verify(x => x.SaveAsync(It.IsAny<ICspSettings>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Never);
    ...
    public async Task SaveAsync_CallsSaveAsyncOnTheRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(x => x.SaveAsync(It.IsAny<ICspSettings>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once);
    }
