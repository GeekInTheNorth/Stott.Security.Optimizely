...
public sealed class SaveCustomHeaderModelTests
{
    ...
    public void Validate_GivenDuplicateHeaderName_ThenReturnsError()
    {
        ...
        _mockRepository.Setup(x => x.GetByHeaderNameAsync("X-Duplicate", It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new CustomHeader { Id = existingId, HeaderName = "X-Duplicate" });
    ...
    public void Validate_GivenSameHeaderNameSameId_ThenReturnsNoDuplicateError()
    {
        ...
        _mockRepository.Setup(x => x.GetByHeaderNameAsync("X-Same", It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new CustomHeader { Id = sameId, HeaderName = "X-Same" });
